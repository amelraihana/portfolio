<template>
  <main
    ...
    <div class="space-y-2 text-center md:text-left px-10">
      ...
      <h1 class="text-4xl font-bold md:text-5xl text-white fadein-up">Amelia</h1>
      <div class="py-2">
        <h1
...
export default {
  ...
  data() {
    return {
      toRotate: ["Tech Enthusiast", "Full-Stack Engineer" , "Computer Science Student", "Specialized in Software Engineering"],
      period: 2000,
      txt: '',
      loopNum: 0,
      isDeleting: false,
