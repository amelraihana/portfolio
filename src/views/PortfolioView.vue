            ...
            <div v-for="item in items" :key="item.id">
              ...
              >
                ...
                >
                  ...
                  <div
                    class="w-full mt-4 text-normal text-sm text-left text-rose-200"
                  >
                    {{ item.tech }}
                  </div>
